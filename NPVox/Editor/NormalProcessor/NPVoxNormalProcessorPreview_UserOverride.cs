...
public class NPVoxNormalProcessorPreview_UserOverride : NPVoxNormalProcessorPreview
{
    ...
    private VoxCoord m_lastSelected = VoxCoord.INVALID;
    ...
    public override void SetContext(NPVoxNormalProcessorPreviewContext _context)
    {
        ...
        VoxCoord size = m_context.MeshOutput.GetVoxModel().Size;
    ...
    private void ResetSelection()
    {
        ...
        m_lastSelected = VoxCoord.INVALID;
        m_lastSelectedData = null;
    }

    private void ApplyNormalStage()
    {
        VoxModel voxModel = m_context.MeshOutput.GetVoxModel();
    ...
    {
        List<VoxCoord> overridesToRemove = new List<VoxCoord>();
        ...
        foreach (VoxCoord i in overridesToRemove)
        {
    ...
    private sbyte GetSelection(VoxCoord _coord)
    {
        int iIndex = m_context.MeshOutput.GetVoxModel().GetIndex(_coord);
        return m_selections[iIndex];
    }

    private void SetSelection(VoxCoord _coord, sbyte _selection)
    {
        int iIndex = m_context.MeshOutput.GetVoxModel().GetIndex(_coord);
